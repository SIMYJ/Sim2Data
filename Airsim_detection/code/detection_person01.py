...
client.simSetDetectionFilterRadius(camera_name, image_type, 1000 * 500) 
...
while True:
    ...
    if people:
        for person in people:
            ...
            save_scenery_label(personJSONData) # JSON파일 저장
            save_scenery_orignal(png) #원본이미지 저장
    ...
    if cv2.waitKey(1) & 0xFF == ord('q'):
        ...
        client.simAddDetectionFilterMeshName(camera_name, image_type, "Person*")
    save_scenery_bbox(png) #detection 저장
